...
import { FaUpload, FaImage, FaMagic, FaSpinner, FaCheck, FaTimes } from 'react-icons/fa';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-emerald-950 text-gray-100 p-4 md:p-8">
      ...
      <main className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-xl md:text-2xl font-semibold mb-4 text-emerald-300">Upload Your Image</h2>
          
          <div className="flex flex-col md:flex-row gap-6">
            {/* Upload Area */}
            <div 
              className={`flex-1 border-2 border-dashed ${error && !selectedFile ? 'border-red-500' : 'border-gray-600'} rounded-xl p-6 flex flex-col items-center justify-center cursor-pointer hover:border-emerald-400 transition-colors`}
            ...
            <div className="flex-1 flex items-center justify-center">
              {previewUrl ? (
                ...
                <div className="w-full h-64 md:h-80 bg-gray-900 rounded-xl flex items-center justify-center">
        ...
        {selectedFile && (
          <motion.section
            ...
            className="bg-gray-800 bg-opacity-50 backdrop-blur-lg rounded-xl p-6 mb-8 border border-gray-700"
          >
            <h2 className="text-xl md:text-2xl font-semibold mb-4 text-emerald-300">Transformation Options</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
              {options.map((option) => (
                <motion.button
                  ...
                  className={`flex items-center space-x-3 p-4 rounded-lg border ${selectedOption === option.id ? 'border-emerald-400 bg-emerald-900 bg-opacity-30' : 'border-gray-600 hover:border-emerald-300'}`}
                >
            ...
            {(selectedOption === 'style' || selectedOption === 'generate') && (
              <div className="mb-6">
                ...
                <textarea
                  ...
                  placeholder={selectedOption === 'style' ? 'Describe the style you want (e.g., "cyberpunk neon")' : 'Describe what to add (e.g., "futuristic city in background")'}
            ...
            >
              ...
              {isGenerating ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-lg font-medium mb-2 text-gray-300">Original</h3>
                  ...
                  <div>
                    <h3 className="text-lg font-medium mb-2 text-emerald-300">Transformed</h3>
                    <div className="relative w-full h-64 md:h-80 rounded-xl overflow-hidden bg-gray-900">
                      <img 
                        src={generatedImage} 
                        alt="AI Generated" 
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4">
                        <div className="flex justify-between items-center">
                          <span className="text-emerald-300 text-sm">AI Generated</span>
