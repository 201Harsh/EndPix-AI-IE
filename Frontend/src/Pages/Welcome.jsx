        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <nav className="flex flex-col items-center space-y-6 text-xl">
              ...
              <Link
                to="/register"
                className="mt-4 px-6 py-3 bg-emerald-600 hover:bg-emerald-500 rounded-full font-medium shadow-lg"
              >
                Sign In
              </Link>
            </nav>
          ...
          <section className="flex flex-col items-center text-center mt-8 md:mt-12 mb-12 md:mb-24">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-6 md:mb-8 px-4">
                EndPix NextGen combines cutting-edge artificial intelligence
                with intuitive controls to transform your photos beyond
                imagination.
              </p>
              <Link
                to="/register"
                        ...
                        <div className="absolute bottom-4 md:bottom-6 left-0 right-0 px-4 md:px-6">
                          <div className="relative group">
                            ...
                            <div className="h-2 bg-gray-700 rounded-full overflow-hidden">
                              ...
                              <div
                                className="h-full bg-gradient-to-r from-emerald-400/30 to-emerald-400 rounded-full"
                            ...
                            />
                            <div
                              className="absolute top-1/2 h-4 w-4 -mt-2 rounded-full bg-emerald-400 shadow-lg transform -translate-x-1/2 z-20
                 transition-all duration-150 ease-out group-hover:scale-125 group-hover:shadow-emerald-400/50"
                              style={{ left: `${sliderValue}%` }}
                            >
                              {/* Inner glow */}
                              <div className="absolute inset-0 rounded-full bg-emerald-400 animate-pulse opacity-70" />
                            </div>

                            {/* Value indicator that follows the thumb */}
                            <div
                              className="absolute -top-8 transform -translate-x-1/2 bg-emerald-600 text-white text-xs font-bold px-2 py-1 rounded-md
                 shadow-lg transition-opacity duration-200 opacity-0 group-hover:opacity-100"
                              style={{ left: `${sliderValue}%` }}
                            >
                              {sliderValue}%{/* Triangle pointer */}
                              <div
                                className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-full w-0 h-0 
                      border-l-4 border-r-4 border-b-0 border-t-4 border-l-transparent border-r-transparent 
                      border-t-emerald-600"
                          ...
                          <div className="flex justify-between text-xs md:text-sm mt-3">
                            <span className="relative bg-gray-700 px-1 text-gray-200 group">
                              Original
                              <span
                                className={`absolute bottom-0 left-0 h-0.5 bg-gray-500 transition-all duration-300 ${
                                  sliderValue < 20 ? "w-full" : "w-0"
                                }`}
                              />
                            </span>
                            <span className="relative px-1 bg-gray-700 text-gray-200 group">
                              AI Enhanced
                              <span
                                className={`absolute bottom-0 left-0 h-0.5 bg-emerald-400 transition-all duration-300 ${
                                  sliderValue > 80 ? "w-full" : "w-0"
                                }`}
                              />
                            </span>
                          </div>
                  ...
                  {activeTab === "transform" && (
                    <div>
                      ...
                      <p className="text-gray-300 mb-4 md:mb-6 max-w-2xl mx-auto text-sm md:text-base">
                        Apply artistic styles to your photos or completely
                        change the mood and atmosphere with AI.
                      </p>
                      <Swiper
                        grabCursor={true}
                        effect={"creative"}
                      ...
                      >
                        {aiTransformations.map((item, index) => (
                          <SwiperSlide
                            key={index}
                            className="bg-gray-900 rounded-lg md:rounded-xl overflow-hidden"
                          >
                  ...
                  {activeTab === "generate" && (
                    <div>
                      ...
                      <p className="text-gray-300 mb-4 md:mb-6 max-w-2xl mx-auto text-sm md:text-base">
                        Describe what you want to add or change, and our AI will
                        generate it seamlessly into your image.
                      </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                          <div>
                            <div className="bg-gray-800 rounded-lg p-3 md:p-4 mb-3 md:mb-4">
                              <h4 className="text-emerald-300 mb-1 md:mb-2 text-sm md:text-base">
                                Prompt Example:
                              </h4>
                              <p className="text-gray-200 italic text-xs md:text-sm">
                                "Add a futuristic cyberpunk city in the
                                background with neon lights, and make the
                                subject wear a high-tech visor"
                              </p>
                            </div>
                          ...
                          <div className="relative h-48 md:h-auto bg-gradient-to-br from-gray-800 to-emerald-900 rounded-lg overflow-hidden flex items-center justify-center">
                            <div className="text-center p-4 md:p-6">
                              ...
                              <h4 className="text-lg md:text-xl font-semibold mb-1 md:mb-2 text-emerald-300">
                                AI Generated Result
                              </h4>
                              <p className="text-gray-300 text-xs md:text-sm">
                                The AI analyzes your prompt and generates new
                                elements that blend perfectly with your original
                                image.
                              </p>
                            </div>
                          </div>
          ...
          <section className="py-12 md:py-16">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
                EndPix NextGen provides everything you need to transform your
                images with AI
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 px-4 md:px-0">
              {features.map((feature, index) => (
                ...
                >
                  <div className="text-emerald-400 mb-3 md:mb-4">
                    {feature.icon}
                  </div>
          ...
          <section className="py-16 md:py-20 px-4">
            <div className="bg-gradient-to-r from-emerald-900 to-teal-900 rounded-xl md:rounded-2xl p-6 md:p-12 text-center">
              ...
              <p className="text-lg md:text-xl text-emerald-100 max-w-2xl mx-auto mb-6 md:mb-8">
                Join thousands of creators who are already using EndPix NextGen
      ...
      >
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            ...
            <div>
              <h4 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-emerald-300">
                Product
              </h4>
          ...
          <div className="border-t border-gray-800 mt-8 md:mt-12 pt-6 md:pt-8 text-center text-gray-500 text-sm md:text-base">
            <p>
              © {new Date().getFullYear()} EndPix NextGen. All rights reserved.
            </p>
          </div>
        </div>
      </motion.footer>
